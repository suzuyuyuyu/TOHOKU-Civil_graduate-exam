...
\begin{ans*}
  ...
  \begin{align}
    ...
    = \lim_{\Delta x\to +0}\frac{1}{1+e^{\frac{1}{\Delta x}}}
    = 0 \\
    \lim_{\Delta x\to -0}\frac{f(\Delta x) - f(0)}{\Delta x}
    = \lim_{\Delta x\to -0}\frac{1}{1+e^{\frac{1}{\Delta x}}}
    = 1
...
\begin{ans*}
  ...
  \begin{enumerate}[label=(\arabic*)]
    ...
    \begin{align}
      ...
      &= \int_{0}^{\pi/2} \Biggl( \frac{1}{3} - \frac{1}{3}\cos^3\grt \Biggr)\, d\grt \\
      &= \frac{\pi}{6} - \frac{2}{9}
    \end{align}
  \end{enumerate}
\end{ans*}
...
\begin{ans*}
  ...
  \begin{enumerate}[label=(\arabic*)]
    ...
    \begin{gather}
      ...
      =
      \bmat{
          \disp \frac{\sqrt{3}}{2} & \disp -\frac{1}{2} \\[10pt]
          \disp \frac{1}{2} & \disp \frac{\sqrt{3}}{2}
      } =
      \bmat{
        \disp \cos\frac{\pi}{6} &\disp \sin\frac{\pi}{6} \\[10pt]
        \disp -\sin\frac{\pi}{6} &\disp \cos\frac{\pi}{6} \\
      }
    \end{gather}
    であるので、\dm{\frac{\pi}{6}}方向の回転行列である。
    \dm{\Bmat{x \\[5pt] y} = \bP\Bmat{X \\Y}}の座標変換によって
    \begin{align}
      &f(x, y, 0) = 1 \\
      &\quad\eqa
      \Bmat{x & y}\bP\bP^{-1}\bA\bP\bP^{-1}\Bmat{x \\ y} \\
      &\quad\eqa
      \Bmat{X & Y}\bP^{-1}\bA\bP\Bmat{X \\ Y} \\
      &\quad\eqa
