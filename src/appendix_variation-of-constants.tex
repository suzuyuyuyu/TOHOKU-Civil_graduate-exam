...
そのため\refeq{27}のように$C'_{1}y_{1}+C'_{2}y_{2}=0$というような条件を追加で仮定することで
...
\begin{itembox}[l]{非斉次方程式の一般解の公式}
  ...
  \begin{itemize}
    ...
    \item $W(x)\colon$以下で定義される$x$の関数（ロンスキアン）
    \begin{gather}
