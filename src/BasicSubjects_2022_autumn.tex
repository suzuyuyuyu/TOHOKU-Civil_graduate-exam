...
\prob{%
  次の関数$f(x,y)$の極値を求めよ。
  \begin{gather}
    f(x,y) = xy + \frac{8}{x} + \frac{8}{y} \quad(x\neq 0,\, y\neq 0)
  \end{gather}
}
\begin{ans*}
  停留点であるためには
  ...
  \begin{align}
    ...
    \det
    \bmat{
    \disp\frac{\d^2f}{\d x^2} & \disp\frac{\d^2f}{\d x\d y} \\[10pt]
    \disp\frac{\d^2f}{\d x\d y} & \disp\frac{\d^2f}{\d y^2}
    }\right|_{(x,y) = (2,2)} \\
    &=
    \begin{vmatrix}
      \disp\frac{16}{x^3} & \disp 1 \\[10pt]
      \disp 1 & \disp\frac{16}{y^3}
    \end{vmatrix} \\
    &=
    \begin{vmatrix}
      \disp 2 & \disp 1 \\[10pt]
    ...
    = 3 > 0
  \end{align}
  より\dm{\bH \succ 0}なので\dm{(x,y) = (2,2)}で極小値12をとる。
\end{ans*}
...
\begin{ans*}
  ...
  \begin{enumerate}[label=(\arabic*)]
    ...
    \begin{figure}[H]\centering
      \includegraphics[width=.6\linewidth]{./src/fig/Basic/B_2022_autumn_D.png}
    \end{figure}
    ...
    \begin{align}
      ...
      &= \Dset{(r,\theta)\relmiddle 0\leq r\leq 2\cos\theta, -\frac{\pi}{2}\leq \theta < \frac{\pi}{2}}
    \end{align}
    であるので、
    \begin{align}
      V_{D}
      &= \int_{-\pi/2}^{\pi/2}\int_{0}^{2\cos\theta}r^3\,drd\theta \\
      &= \int_{-\pi/2}^{\pi/2} 4\cos^4\theta\,d\theta \\
      &= \int_{-\pi/2}^{\pi/2} \left(1 + 2\cos\theta + \frac{1 + \cos4\theta}{2}\right)\,d\theta \\
      &= \frac{3\pi}{2}
    \end{align}
  \end{enumerate}
...
\begin{ans*}
  ...
  \begin{enumerate}[label=(\arabic*)]
    ...
    \begin{gather}
      \ba_2 = (\ba_2\cdot\bb_1)\bb_1 + \bb'_2
    \end{gather}
    よって、$\bb_2$は
    \begin{align}
      \bb_2
