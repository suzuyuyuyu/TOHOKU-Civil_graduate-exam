...
\begin{enumerate}[label=(\arabic*)]
  ...
  ${}$
  \begin{figure}[H]\centering
    \includegraphics[width=.6\linewidth]{./src/fig/Basic/B_2021_autumn_D.png}
  \end{figure}
  ...
  \begin{align}
    I
    &= \frac{1}{2}\left[x\sqrt{(1-z)^2 - x^2} + (1-z)^2\arcsin \frac{x}{1-z}\right]_{0}^{z} \\
...
\prob{
  正方行列\dm{\bA = \bmat{
    \disp\frac{21}{4} & \disp\frac{5\sqrt{3}}{4} \\[10pt]
...
\begin{ans*}
  ...
  \begin{enumerate}[label=(\arabic*)]
    ...
    \begin{enumerate}[label=(\roman*)]
      ...
      \begin{gather}
        \bmat{
          \disp -\frac{15}{4} & \disp \frac{5\sqrt{3}}{4} \\[10pt]
    ...
    \begin{gather}
      \bP_1^{-1}\bA\bP_1 = \bmat{9 & 0 \\ 0 & 4} = \bmat{\pm 3 & 0 \\ 0 & \pm 2}^2  \\
      \bP_2^{-1}\bA\bP_2 = \bmat{4 & 0 \\ 0 & 9} = \bmat{\pm 2 & 0 \\ 0 & \pm 3}^2
    \end{gather}
    と対角化できる。ただし、いずれも複号任意である。
    また、
    \begin{gather}
    ...
    であるので、
    \begin{gather}
      \bP_1^{-1}\bA^{\frac{1}{2}}\bP_1 = \bmat{\pm 3 & 0 \\ 0 & \pm 2} \\
      \bP_2^{-1}\bA^{\frac{1}{2}}\bP_2 = \bmat{\pm 2 & 0 \\ 0 & \pm 3}
    \end{gather}
    が成り立つ。ただし、いずれも複号任意である。
    よって、$\bA^{\frac{1}{2}}$は4つ得られて
    \begin{align}
      \bA^{\frac{1}{2}}
      &=
      \bP_1\bmat{\pm 3 & 0 \\ 0 & \pm 2}\bP_1^{-1},\,
      \bP_2\bmat{\pm 2 & 0 \\ 0 & \pm 3}\bP_2^{-1} \\
      &=\bmat{
        \disp\pm\frac{9}{4} & \disp\pm\frac{\sqrt{3}}{4} \\[10pt]
        \disp\pm\frac{\sqrt{3}}{4} & \disp\pm\frac{11}{4}
      },\,\bmat{
        \disp\mp\frac{3}{4} & \disp\pm\frac{5\sqrt{3}}{4} \\[10pt]
        \disp\pm\frac{5\sqrt{3}}{4} & \disp\pm\frac{7}{4}
      }\quad\text{（行列内は複号同順）}
    \end{align}
